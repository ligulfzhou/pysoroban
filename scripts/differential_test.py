...
SUITES = (
    ...
    (
        ...
        (
            ...
            ("u128-mul-div-wide", "mul_div_floor", (2**120, 2**120, 2**116)),
            ("u128-mul-div-floor", "mul_div_floor", (10, 7, 6)),
            ("u128-mul-div-composed", "composed_scale", (8, 2, 7, 6)),
            ("u128-mul-div-zero", "mul_div_floor", (1, 1, 0), "unreachable"),
            ("u128-mul-div-overflow", "mul_div_floor", (2**128 - 1, 2, 1), "unreachable"),
